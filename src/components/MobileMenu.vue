...
<template>
    <section>
        ...
        <!-- Menu -->
        <section
            class="slide w-[75%] h-screen bg-white/95 absolute left-0 top-0 p-5 backdrop-blur-lg shadow-lg overflow-y-auto overflow-x-hidden">
            ...
            <div>
                <div class="mb-4">
                    <input type="text"
                        class="w-full bg-zinc-100 p-3 placeholder:text-xs outline-none rounded-md placeholder:text-zinc-400/70"
            ...
            <div>
                <nav class="flex flex-col gap-y-4 font-semibold">
                    <RouterLink @click="emitClose" to="/" class="flex items-center gap-x-2">
                        <span class="bg-blue-200/80 p-2 rounded-lg">
                            <!-- HomeIcon -->
                            <HomeIcon></HomeIcon>
                        </span>
                        خانه
                    ...
                    <RouterLink @click="emitClose" to="/courses" class="flex items-center gap-x-2">
                        <span class="bg-red-200/80 p-2 rounded-lg">
                            <!-- VideoIcon -->
                            <VideoIcon></VideoIcon>
                        </span>
                        دوره ها
                    ...
                    <RouterLink @click="emitClose" to="/articles" class="flex items-center gap-x-2">
                        <span class="bg-purple-200/80 p-2 rounded-lg">
                            <ArticleIcon></ArticleIcon>
                        </span>
                        مقالات
                    </RouterLink>
                    <RouterLink @click="emitClose" to="/podcasts" class="flex items-center gap-x-2">
                        <span class="bg-green-200/80 p-2 rounded-lg">
                            <!-- PodcastIcon -->
                    ...
                    <RouterLink @click="emitClose" to="/roadmap" class="flex items-center gap-x-2">
                        <span class="bg-orange-200/80 p-2 rounded-lg">
                            <!-- MapIcon -->
                            <MapIcon></MapIcon>
                        </span>
                        نقشه راه
            ...
            <footer id="mobile-menu-footer" class=" w-full absolute bottom-5 pl-10">
                <div class="flex flex-col gap-y-1 text-zinc-500">
                    <p class="text-sm font-semibold">ایران یک دو سه</p>
                    <p class="text-xs">تلفن پشتیبانی: <span dir="ltr">021-77539482</span></p>
                </div>
