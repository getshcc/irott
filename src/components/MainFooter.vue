...
<template>
    ...
    <footer class="bg-zinc-50 dark:bg-zinc-900/40 p-5 px-10 absolute w-screen left-0 z-[-1]">
        <section class="container mx-auto lg:pr-5">

            <!-- Webapp identify -->
            <div class="flex flex-col md:flex-row items-center justify-between pb-5">
                <div class="hidden items-center md:flex gap-x-2">
            ...
            <div>
                ...
                <!-- Company and Contact address -->
                <div class="pb-3 flex flex-col lg:flex-row justify-between items-center">
                    <p class="text-xs font-medium flex items-center gap-x-1 pb-4 lg:pb-0 text-center">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 25 25" stroke-width="1.7"
                        ...
                        ایران- تهران- خیابان دکتر شریعتی- خیابان بهار شیراز- پلاک ۳۶۸ - ساختمان ایران ۱۲۳
                    </p>
                ...
                <div class="border-t dark:border-zinc-800 pt-3 flex flex-col xl:flex-row items-center justify-between ">
                    <p class="text-xs text-center text-zinc-500">تمام حقوق مادی و معنوی برای
                        ...
                        <span class="mr-1">طراحی و توسعه: <a class="font-bold"
                                href="https://instagram.com/iamshcc">ShCc</a></span>
                    </p>
                    <ul class="text-xs flex gap-x-4 font-medium text-zinc-500 pt-3 xl:pt-0">
                        <li><a class="hover:text-sky-500" href="">توییتر</a></li>
                        <li><a class="hover:text-orange-500" href="">اینستاگرام</a></li>
                        <li><a class="hover:text-blue-500" href="">تلگرام</a></li>
                        <li><a class="hover:text-red-500" href="">یوتیوب</a></li>
                    </ul>
                </div>
